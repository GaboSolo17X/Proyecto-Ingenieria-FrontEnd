      ...
      try {
        ...
        if (
          ...
          if (
            ...
            showAlertFail(
              "La fecha de inicio o fecha de finalización seleccionada coincide con las fechas del proceso de planificación académica, por favor seleccione fechas para matricula después del " +
