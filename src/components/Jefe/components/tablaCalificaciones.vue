    ...
    <template v-slot:text>
      <v-row align="center">
        <v-col>
          <v-text-field
            v-model="search"
            label="Buscar docente por su nombre"
            single-line
            variant="outlined"
...
export default {
  ...
  methods: {
    verCalificaciones(nombreDocente, clase, asignatura, seccion, idseccion) {
      console.log(nombreDocente, clase, asignatura, seccion, idseccion);
      this.$router.push({
